...
function EmuList_ExistingHorses(x, y, w, h, text, element_height, content_slots, callback): EmuList(x, y, w, h, text, element_height, content_slots, callback) constructor {
    self.entries_are = E_ListEntryTypes.STRUCTS;
    ...
    self.Render = function(base_x, base_y) {
        ...
        show_debug_message(self.entries);
        show_debug_message("n: " + string(n));
        show_debug_message("slots: " + string(self.slots));
        show_debug_message("index: " + string(self.index));
        ...
        if (n == 0) {
            ...
            for (var i = 0; i < min(n, self.slots); i++) {
                ...
                switch (self.entries_are) {
                  case E_ListEntryTypes.STRUCTS: index_text += string(self.entries[current_index].total); break;
                }
