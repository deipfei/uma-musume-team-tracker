/// @description  draw_graph_grid(x, y, width, height, variable, variable, ...)
/// @param x
/// @param  y
/// @param  width
/// @param  height
...
/// @param  variable
/// @param  ...
function draw_graph_grid() {
	var table=0, X=argument[0], Y=argument[1], w=argument[2], h=argument[3], index=0, maks, c;
